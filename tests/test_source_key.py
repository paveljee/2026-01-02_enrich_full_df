...
class TestRegisteredResource:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("file:///C:/Users/user/data.csv", "C:/Users/user/data.csv"),
            ("file:///home/user/spaced%20file.csv", "/home/user/spaced file.csv"),
        ],
    )
...
class TestSourceKey:
    ...
    def test_fragment_has_type_mixin(self, sample_resource):
        ...
        assert sk.fragment == "A12345"
        assert sk.fragment.type == FragmentType.AUTHOR_ID
        assert len(sk.fragment) == 6
...
class TestRegisteredResourceEnhanced:
    ...
    def test_hash_verification_on_init(self, tmp_path):
        """Test hash verification on initialization."""
        ...
        # Create resource with correct hash
        resource = RegisteredResource(
            name="test.txt",
            hash=file_hash,
            group=ResourceGroup.KTP_PILOT_SAMPLE,
    ...
    def test_skip_hash_verification(self, tmp_path):
        """Test skipping hash verification."""
        test_file = tmp_path / "test.txt"
        test_file.write_text("test content")
        ...
        assert resource.hash == "wrong_hash"
