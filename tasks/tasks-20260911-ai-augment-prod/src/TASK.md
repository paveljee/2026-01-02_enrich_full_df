...
TASK_DIR="$PWD/tasks/tasks-20260911-ai-augment-prod"
...
### actual task
A prior task at 
`$PWD/tasks/tasks-20260731-tighten-api/var/WORK.md`
implemented the detour codebase at
`src/detours/detour_ai_augment/protected/src` and
`src/detours/detour_ai_augment/src`
and the tests at
`src/detours/detour_ai_augment/protected/tests` and
`src/detours/detour_ai_augment/tests`,
governed by the authoritative
`src/detours/detour_ai_augment/README.md`.
Your TASK is to work with the Human Operator
to prepare this for production.
