...
<!---suspended until further notice as of 2026-08-25
...
```gherkin
Scenario: test_s001_01
  Given `--config` is passed
  When it is a valid `AiAugmentDetourConfig`
  And relevant fields from `PipelineConfig` are readable
...
<!--suspended until further notice as of 2026-08-24
