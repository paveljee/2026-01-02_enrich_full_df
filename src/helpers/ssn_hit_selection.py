    ...
    return f"""
        ...
        flagged_metrics AS (
            SELECT
                c.*,
                COALESCE(
                    c.ssn_hit_sum_hit_1pct_metric < b.ssn_q1 - 1.5 * (b.ssn_q3 - b.ssn_q1)
                    OR c.ssn_hit_sum_hit_1pct_metric > b.ssn_q3 + 1.5 * (b.ssn_q3 - b.ssn_q1),
                    false
                ) AS ssn_hit_sum_hit_1pct_is_tukey_outlier,
                COALESCE(
                    c.ssn_hit_works_count_metric < b.works_q1 - 1.5 * (b.works_q3 - b.works_q1)
                    OR c.ssn_hit_works_count_metric > b.works_q3 + 1.5 * (b.works_q3 - b.works_q1),
                    false
                ) AS ssn_hit_works_count_is_tukey_outlier,
                COALESCE(
                    c.ssn_hit_cited_by_count_metric < b.cited_q1 - 1.5 * (b.cited_q3 - b.cited_q1)
                    OR c.ssn_hit_cited_by_count_metric
                        > b.cited_q3 + 1.5 * (b.cited_q3 - b.cited_q1),
                    false
