...
The 2025-08-19 sampler logic is the authoritative source and **must be reused with minimal changes** (do not alter logic or comments unless strictly required for integration):

- Local copy saved in this repo: `./pkg_20250819_sampler/src/sampler.py`
...
1. **Create the new project module** inside `./pkg_20260126_roadmap/`.
   - Implement a sampler module that is functionally identical to `pkg_20250819_sampler/src/sampler.py`.
